...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/TEAM-ISTKHAR/ClassyMusic",
)
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://files.catbox.moe/jobnyc.jpg"
)
PING_IMG_URL = getenv(
    "PING_IMG_URL", "https://files.catbox.moe/0twom7.jpg"
)
...
YOUTUBE_IMG_URL = "https://files.catbox.moe/0twom7.jpg"
